...
import com.vault.fide.app.event.SystemEventReceiver;
import com.vault.fide.app.terminal.TermuxTerminalSessionActivityClient;
import com.vault.fide.app.terminal.TermuxTerminalSessionServiceClient;
import com.vault.fide.shared.termux.plugins.TermuxPluginUtils;
import com.vault.fide.shared.data.IntentUtils;
import com.vault.fide.shared.net.uri.UriUtils;
import com.vault.fide.shared.errors.Errno;
import com.vault.fide.shared.shell.ShellUtils;
import com.vault.fide.shared.shell.command.runner.app.AppShell;
import com.vault.fide.shared.termux.settings.properties.TermuxAppSharedProperties;
import com.vault.fide.shared.termux.shell.command.environment.TermuxShellEnvironment;
import com.vault.fide.shared.termux.shell.TermuxShellUtils;
import com.vault.fide.shared.termux.TermuxConstants;
import com.vault.fide.shared.termux.TermuxConstants.TERMUX_APP.TERMUX_ACTIVITY;
import com.vault.fide.shared.termux.TermuxConstants.TERMUX_APP.TERMUX_SERVICE;
import com.vault.fide.shared.termux.settings.preferences.TermuxAppSharedPreferences;
import com.vault.fide.shared.termux.shell.TermuxShellManager;
...
import com.vault.fide.shared.logger.Logger;
import com.vault.fide.shared.notification.NotificationUtils;
import com.vault.fide.shared.android.PermissionUtils;
import com.vault.fide.shared.data.DataUtils;
import com.vault.fide.shared.shell.command.ExecutionCommand;
import com.vault.fide.shared.shell.command.ExecutionCommand.Runner;
import com.vault.fide.shared.shell.command.ExecutionCommand.ShellCreateMode;
import com.vault.fide.terminal.TerminalEmulator;
...
public final class TermuxService extends Service implements AppShell.AppShellClient, TermuxSession.TermuxSessionClient {
     ...
     * the results forever like in case of commands started by Vault.Fide:Tasker or RUN_COMMAND intent,
     ...
     * be used, like in Tasker for the Vault.Fide:Tasker actions.
     *
    ...
    private synchronized void killAllTermuxExecutionCommands() {
        ...
        for (int i = 0; i < pendingPluginExecutionCommands.size(); i++) {
            ...
            if (!executionCommand.shouldNotProcessResults() && executionCommand.isPluginExecutionCommandWithPendingResult()) {
                if (executionCommand.setStateFailed(Errno.ERRNO_CANCELLED.getCode(), this.getString(com.vault.fide.shared.R.string.error_execution_cancelled))) {
